...
<form id="scheduleForm" action="process.php" method="post" class="needs-validation" novalidate>
    ...
    <div id="additionalTimes" class="mb-3 row">
        ...
        <div class="mb-3 row">
            <input type="hidden" name="schedule_id[]" value="<?php echo $row['course_schedule_id']; ?>">
            ...
            <div class="col-sm-2">
                <select class="form-select" name="dayOfWeek[]" required>
                    ...
                    <option value="sunday" <?php if ($row['day_of_week']==1) echo 'selected'; ?>>Chủ nhật</option>
                </select>
            </div>
    ...
    <div class="mb-3 row">
        <div class="col-sm-12">
            ...
            <button type="submit" class="btn btn-success" name="update_schedule">Cập nhật thời khóa biểu</button>
            <a href="course_show.php?id=<?php echo $course_id; ?>" class="btn btn-secondary">Quay lại</a>
        </div>
    </div>
</form>
</div>

    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="/teacher/course/index.php">Trang chủ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/teacher/course/post/post.php">Bài đăng</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/teacher/course/content/content.php">Nội dung</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/teacher/course/exam/exam.php">Bài tập và kiểm tra</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/teacher/course/grade/grade_column.php">Điểm số</a>
                    </li>
                </ul>
